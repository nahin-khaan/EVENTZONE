...
public class SoundCategoryCreate extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_category_create);

        databaseReference = FirebaseDatabase.getInstance().getReference("SoundLight");
        storageReference = FirebaseStorage.getInstance().getReference("SoundLight");
        tittle = findViewById(R.id.tittleEditId);
        category = findViewById(R.id.categorySpinId);
        category_names = getResources().getStringArray(R.array.category_names_sound);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(SoundCategoryCreate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void eventAdd() {
        ...
        ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getApplicationContext(), "Sound and light Event create  Succesfully Done", Toast.LENGTH_LONG).show();
                ...
                Intent intent=new Intent(SoundCategoryCreate.this,MainActivity.class);
