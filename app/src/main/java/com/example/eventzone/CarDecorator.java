...
public class CarDecorator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_decorator);
        recyclerView = findViewById(R.id.carEventListRecycleId);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                stageAdapter = new StageAdapter(CarDecorator.this, categoryList);
