...
public class VideoCategoryCreate extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_category_create);

        databaseReference = FirebaseDatabase.getInstance().getReference("Videographer");
        storageReference = FirebaseStorage.getInstance().getReference("Videographer");
        tittle = findViewById(R.id.tittleEditId);
        category = findViewById(R.id.categorySpinId);
        category_names = getResources().getStringArray(R.array.category_names_videographer);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(VideoCategoryCreate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void eventAdd() {
        ...
        ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getApplicationContext(), "VideoGraphers Event create  Succesfully Done", Toast.LENGTH_LONG).show();
                ...
                Intent intent=new Intent(VideoCategoryCreate.this,MainActivity.class);
