...
public class CarrentCategoryCreate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carrent_category_create);

        databaseReference = FirebaseDatabase.getInstance().getReference("CarRent");
        storageReference = FirebaseStorage.getInstance().getReference("CarRent");
        tittle = findViewById(R.id.tittleEditId);
        category = findViewById(R.id.categorySpinId);
        category_names = getResources().getStringArray(R.array.category_names_carrent);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(CarrentCategoryCreate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void eventAdd() {
        ...
        ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getApplicationContext(), "Carrent Event create  Succesfully Done", Toast.LENGTH_LONG).show();
                ...
                Intent intent=new Intent(CarrentCategoryCreate.this,MainActivity.class);
