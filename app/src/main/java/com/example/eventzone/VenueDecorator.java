...
public class VenueDecorator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_venue_decorator);
        recyclerView = findViewById(R.id.venueEventListRecycleId);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                stageAdapter = new StageAdapter(VenueDecorator.this, categoryList);
