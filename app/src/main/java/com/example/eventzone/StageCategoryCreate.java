...
public class StageCategoryCreate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stage_category_create);

        databaseReference = FirebaseDatabase.getInstance().getReference("Stage");
        storageReference = FirebaseStorage.getInstance().getReference("Stage");
        tittle = findViewById(R.id.tittleEditId);
        category = findViewById(R.id.categorySpinId);
        category_names = getResources().getStringArray(R.array.category_names_stage);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(StageCategoryCreate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void eventAdd() {
        ...
        ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getApplicationContext(), "Stage Event create  Succesfully Done", Toast.LENGTH_LONG).show();
                ...
                Intent intent=new Intent(StageCategoryCreate.this,MainActivity.class);
