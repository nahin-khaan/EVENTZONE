...
public class FoodCategoryCreate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_category_create);
        ...
        category_names = getResources().getStringArray(R.array.category_names_food);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(FoodCategoryCreate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        month = month + 1;
                        String dates = day + "/" + month + "/" + year;
    ...
    private void eventAdd() {
        ...
        ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getApplicationContext(), "Food Event create  Succesfully Done", Toast.LENGTH_LONG).show();
                ...
                Intent intent=new Intent(FoodCategoryCreate.this,MainActivity.class);
