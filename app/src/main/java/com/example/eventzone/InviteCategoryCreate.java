...
public class InviteCategoryCreate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invite_category_create);

        databaseReference = FirebaseDatabase.getInstance().getReference("Invitecard");
        storageReference = FirebaseStorage.getInstance().getReference("Invitecard");
        tittle = findViewById(R.id.tittleEditId);
        category = findViewById(R.id.categorySpinId);
        category_names = getResources().getStringArray(R.array.category_names_invite);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(InviteCategoryCreate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void eventAdd() {
        ...
        ref.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getApplicationContext(), "Invitation card Event create  Succesfully Done", Toast.LENGTH_LONG).show();
                ...
                Intent intent=new Intent(InviteCategoryCreate.this,MainActivity.class);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(), " Event create not  Succesfull", Toast.LENGTH_SHORT).show();
